...
from achilles_api.engine.cascade import cascade, cascade_compound
from achilles_api.models.events import Event
from achilles_api.models.graph import Graph, Node
...
def _to_nx_undirected(graph: Graph) -> nx.Graph:
    """Convert the Achilles *Graph* to an undirected NetworkX graph.
