...
# ---------------------------------------------------------------------------
# Utility: convert Halkantir Graph -> networkx + matrices
# ---------------------------------------------------------------------------


def _to_networkx(graph: Graph) -> nx.DiGraph:
    """Build a networkx DiGraph from a Halkantir Graph, using current edge
...
def refine_weights(
    ...
    """Run the 6-method weight inference pipeline on a Halkantir Graph.
